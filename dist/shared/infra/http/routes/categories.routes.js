...
const importCategoriesController = new _ImportCategoryController.ImportCategoryController();
...
categoriesRoutes.post("/import", upload.single("file"), _ensureAuthenticated.ensureAuthenticated, _ensureAdmin.ensureAdmin, importCategoriesController.handle);